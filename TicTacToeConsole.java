...
public class TicTacToeConsole {
	...
	private char mBoard[] = {'1','2','3','4','5','6','7','8','9'}; //This is the representation of the logic to represent the board
	...
	public TicTacToeConsole() {
		...
		{	
			...
			//user player moves and updates the game board
			if (turn == HUMAN_PLAYER)
			{
				getUserMove();
				turn = COMPUTER_PLAYER;
			}
			//computer moves and updates the game board
			else
			{
				getComputerMove();
				turn = HUMAN_PLAYER;
			...
			//runs check for the winner algorithm
			win = checkForWinner();
		}
	...
	//prints out the testual representation of the game board
